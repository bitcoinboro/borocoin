# PSBT Howto for Borocoin Core

Since Borocoin Core 0.17, an RPC interface exists for Partially Signed Borocoin
...
PSBT is an interchange format for Borocoin transactions that are not fully signed
...
#### Multisig with multiple Borocoin Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
Borocoin Core. We assume their wallets only contain the multisig funds. In case
