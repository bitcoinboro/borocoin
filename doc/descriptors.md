# Support for Output Descriptors in Borocoin Core

Since Borocoin Core v0.17, there is support for Output Descriptors. This is a
...
on Borocoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Borocoin Core wallets, a convenience function `combo` is
