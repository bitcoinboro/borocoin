...
### Borocoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Borocoin Core for Linux, Windows, and macOS:
...
- Announce the release:
  ...
  - Optionally twitter, reddit /r/Borocoin, ... but this will usually sort out itself
