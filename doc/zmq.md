...
The Borocoin Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Borocoin Core requires the ZeroMQ API >= 4.0.0
...
using. Borocoind appends an up-counting sequence number to each
